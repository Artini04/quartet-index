...
<template>
  <main class="about | clamped">
    <div class="about__banner">
      ...
      <p>
        Lesson number are colored based on their respective book color. I also
        added links from English-Japanese dictionaries to access them easier.
      ...
      <p>
        ...
        <a href="https://quartet.japantimes.co.jp/en/resource/" target="_blank">
          resources
        </a>
